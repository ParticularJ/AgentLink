...
cmd_install() {
    ...
    print_msg "$GREEN" "=========================================="
    printf "\n"
    print_msg "$YELLOW" "⚠️  请手动运行以下命令完成配置："
    printf "\n"
    print_msg "$CYAN" "   openclaw onboard"
    printf "\n"
    print_msg "$BLUE" "   或查看文档: https://docs.openclaw.ai/start/faq"
    printf "\n"
    print_msg "$CYAN" "🔧 其他常用命令:"
...
main() {
    ...
    case "$cmd" in
        ...
        *) print_msg "$RED" "未知命令: $cmd"; show_help; exit 1 ;;
    esac
}
